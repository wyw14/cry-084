...
func CoverageSortFields() map[string]bool {
	return shared.AllowedSort("created_at", "coverage_basis_points", "abnormal")
}

func TimelineSortFields() map[string]bool { return shared.AllowedSort("created_at", "kind") }
