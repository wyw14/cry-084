...
func snapshotVersion(snapshot template.Snapshot) int { return snapshot.Number }

func snapshotFieldCount(snapshot template.Snapshot) int { return len(snapshot.Fields) }
