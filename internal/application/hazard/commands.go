...
func reviewRestoresAsset(accepted bool) bool { return accepted }
func reviewClosesHazard(accepted bool) bool  { return accepted }
func reviewAuditAction(accepted bool) string {
	if accepted {
		return "hazard.review.accept"
	}
	return "hazard.review.reject"
}
